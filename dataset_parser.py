...
# dataset parsing (first step): python3 dataset_parser.py --dataset_type SYN2020 --dataset_folder ./sample-dataset/ --packets_per_flow 10 --dataset_id SYN2020 --traffic_type all --time_window 10
# dataset parsing (second step): python3 dataset_parser.py --preprocess_folder ./sample-dataset/
...
DOS2019_FLOWS = {'attackers': ['172.16.0.5','11.0.0.210'], 'victims': ['192.168.50.1', '192.168.50.4','10.42.0.2']}

DDOS_ATTACK_SPECS = {
    'DOS2017' : IDS2017_DDOS_FLOWS,
    'DOS2018' : IDS2018_DDOS_FLOWS,
    'sampleflows' : CUSTOM_DDOS_SYN,
...
def main(argv):
    ...
    help_string = 'Usage[0]: python3 dataset_parser.py --dataset_type <dataset_name> --dataset_folder <folder path> --dataset_id <dataset identifier> --packets_per_flow <n> --time_window <t>\n' \
                  'Usage[1]: python3 dataset_parser.py --preprocess_folder <folder path>'
    manager = Manager()
